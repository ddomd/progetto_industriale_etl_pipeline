...
def download_122_54():
    ...
    url_list = [
        f"https://esploradati.istat.it/SDMXWS/rest/data/122_54/A+M.{locations}........./ALL/?detail=full&startPeriod=2016-01-01"
        for locations in location_filters.values()
    ]

    print("- Downloading dataflow 122_54....")
...
def parse_122_54(responses: List[str]):
    # list of columns that have been selected to be dropped during the data exploration phase
    to_drop = [
        "DATAFLOW",
        "ADJUSTMENT",
        "OBS_STATUS",
...
def clean_122_54():
    return parse_122_54(download_122_54())
